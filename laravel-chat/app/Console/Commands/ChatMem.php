...
class ChatMem extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:chat:mem';
     ...
     * @return void
     */
    protected function handleEvent(MessageInterface $message, \Connmix\AsyncNodeInterface $node): void
    {
